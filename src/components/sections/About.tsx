...
const bubbles: Bubble[] = [
  { id: "who", label: "who i am", icon: User, content: "AI Engineer fresh out of KG Reddy (B.Tech CSE + Data Science, 8.36 GPA). I bridge the gap between 'AI prototype' and 'shipped product.'" },
  ...
  { id: "work", label: "how i work", icon: Zap, content: "I like systems that are boring in the best way — reliable, auditable, well-scoped. I build with AI coding tools heavily but own the architecture decisions." },
...
export function About() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-[1] w-full max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
        {/* LEFT */}
        <div className="flex flex-col gap-6 min-w-0">
          ...
          <div className="flex flex-col gap-4 text-[13px] md:text-[14px]" style={{ color: "var(--muted)", lineHeight: 1.8 }}>
            {[
              "I'm an AI Engineer based in Hyderabad, specializing in LLM orchestration, conversational agents, and production-grade backends. B.Tech in Computer Science (Data Science) — GPA 8.36.",
              "At Bradsol, I built a FastAPI backend with a 19-table schema, JWT auth, DB-driven RBAC, and OTP login serving real users across multiple service centers.",
              "At FewShotPrep, I built conversational AI agents and generated 1M+ JSONL tokens using GPT-4o and LLaMA 3 for training pipelines.",
              "I believe the best AI engineers build end-to-end — from raw data to deployed, production-grade tools people actually use.",
            ].map((text, i) => (
              <Reveal key={i} direction="left" delay={0.1 + i * 0.08} as="p">
                {text}
              </Reveal>
            ))}
          </div>
