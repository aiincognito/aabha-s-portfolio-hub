...
export function Contact() {
  return (
    <div
      id="contact"
      className="relative w-full h-full flex items-center justify-center px-6 md:px-10 py-20 overflow-hidden"
    ...
    >
      ...
      <div
        className="relative z-10 flex flex-col items-center text-center gap-6 max-w-xl w-full"
      >
